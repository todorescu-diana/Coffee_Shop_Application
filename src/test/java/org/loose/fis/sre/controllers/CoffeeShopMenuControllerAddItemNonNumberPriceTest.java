...
public class CoffeeShopMenuControllerAddItemNonNumberPriceTest {
    ...
    public static final String NONNUMBERPRICE = "abc";
    public static final String NUMBERPRICE = "8";
