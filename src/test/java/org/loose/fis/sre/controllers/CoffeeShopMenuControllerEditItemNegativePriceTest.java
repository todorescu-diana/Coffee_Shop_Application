...
public class CoffeeShopMenuControllerEditItemNegativePriceTest {
    ...
    public static final String NEGATIVEPRICE1 = "-9";
    public static final String NEGATIVEPRICE2 = "-100";
    ...
    void testCoffeeShopMenuEditItemNegativePrice(FxRobot robot) {
        ...
        assertThat(robot.lookup("#priceField").queryText()).hasText(POSITIVEPRICE + "0");
    }
}
