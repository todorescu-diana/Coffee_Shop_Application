...
public class CoffeeShopMenuControllerEditItemNonNumberPriceTest {
    ...
    public static final String NONUMBERPRICE1 = "28dc";
    ...
    void testCoffeeShopMenuEditItemNonNumberPrice(FxRobot robot) {
        ...
        robot.write(NONUMBERPRICE1);
        robot.clickOn("#addNewItemButton");
        assertThat(robot.lookup("#itemMessage").queryText()).hasText("Price has to be a number.");
        ...
        assertThat(robot.lookup("#priceField").queryText()).hasText(NUMBERPRICE + ".0");
    }
}
